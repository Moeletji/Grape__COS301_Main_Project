...
public class StockManagerUnitTest {
    ...
    /**
     * Test object. Used throughout the unit test. To be instantiated within
     * each new unit test.
     */
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully accept and record an
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully return the correct
     * order list when required..
     */
    ...
    @Test
    /**
     * @brief Tests of the stock manager can successfully remove an order that
     * was made and if the manager can successfully record the order as being
     * removed at the particular time it was removed.
     */
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully edit the price of a
     * specified order and record that the order was modified at the time it was
     * modified.
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully edit the shares of a
     * specified order and record that the order was modified at the time it was
     * modified.
     * @todo Test if edit history is recorded accurately
     */
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully edit the price and
     * shares of a specified order and record that the order was modified at the
    ...
    @Test
    /**
     * @brief Tests if the stock manager can successfully return a snap shot of
     * the market at the particular moment.
     * @todo
     */
