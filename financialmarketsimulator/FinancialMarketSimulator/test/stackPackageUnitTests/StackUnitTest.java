...
public class StackUnitTest {
    ...
    public void lengthTest() throws InterruptedException {
        ...
        MarketEntryAttemptNode node = new MarketEntryAttemptNode(new MarketEntryAttempt(mockPrice, mockNumShares, mockName, MarketEntryAttempt.SIDE.BID));
        MarketEntryAttemptNode node1 = new MarketEntryAttemptNode(new MarketEntryAttempt(mockPrice, mockNumShares, mockName, MarketEntryAttempt.SIDE.BID));
        MarketEntryAttemptNode node2 = new MarketEntryAttemptNode(new MarketEntryAttempt(mockPrice, mockNumShares, mockName, MarketEntryAttempt.SIDE.OFFER));
    ...
    public void pushAndPopTest() throws InterruptedException, EmptyException {
        ...
        MarketEntryAttemptNode expected = new MarketEntryAttemptNode(new MarketEntryAttempt(mockPrice, mockNumShares, mockName, MarketEntryAttempt.SIDE.BID));
        Stack stack = new Stack();
