 ...
 * @author Madimetja
 */
public class PriceMultiLineChart extends ApplicationFrame implements ActionListener{
    ...
    private final Vector<StockManager> indicators;
     ...
     */
    public PriceMultiLineChart(Vector<StockManager> _indicators, Vector<String> _indicatorNames, String _chartTitle, double _yAxisMin, double _yAxisMax) throws NotEnoughDataException
    {
        super(_chartTitle);
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        for( int k = 0; k < this.serieses.size(); k++ )
        {
            ...
            value = ind.getOrderList().getLastTradePrice();
            ser.add(i,value);
